          ...
          "sections": [
                            {
                                "rows": [{
                                         "title": `LIST MENU`,
                                         "description": "List Menu Aespi BOT",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `MY OWNER`,
                                         "description": "List Owner Aespi BOT", 
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `UNREGISTER`,
                    ...
                    "title": "Created By Ariel SP Ganteng"
                  }
                        ], "contextInfo": 
                         { "stanzaId": m.key.id,
...
conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "description": str,
          "footerText": global.botdate,
          "buttonText": "Ariel Sandy Permana",
          "listType": "SINGLE_SELECT",
          "sections": [
                            {
                                "rows": [{
