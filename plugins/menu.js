    ...
    if (teks == '404') {
      return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "footerText": `*╭━━━┳━━━┳━━┳━━━┳╮*\n*┃╭━╮┃╭━╮┣┫┣┫╭━━┫┃*\n*┃┃╱┃┃╰━╯┃┃┃┃╰━━┫┃*\n*┃╰━╯┃╭╮╭╯┃┃┃╭━━┫┃╱╭╮*\n*┃╭━╮┃┃┃╰┳┫┣┫╰━━┫╰━╯┃*\n*╰╯╱╰┻╯╰━┻━━┻━━━┻━━━╯*\nJika Menemukan Button Eror/Tak Terlihat Langsung Ketik Allmenu
     ▌│█║▌║▌║║▌║▌║█│▌
...
Ⓟ = Premium
*© Aespi Botz*`,
          "buttonText": "ARIEL SP GANTENG :V",
          "listType": "SINGLE_SELECT",
          "sections": [
                            {
                                "rows": [{
                                         "title": "[📊] Status",
                                         "description": "Status Aespi Botz",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "[⚡] Speed",
                  ...
                  "description": "Cari Apa² Aja Di Internet",
                  "rowId": ".? internet"
                }, {
